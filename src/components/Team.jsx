      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {!hideHeader && (
          <div className="text-center max-w-2xl mx-auto mb-14">
            <div className="inline-block px-3 py-1 rounded-full bg-rose-50 border border-rose-200 text-rose-700 text-xs font-semibold tracking-wider uppercase mb-4">
              Our Team
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5 max-w-6xl mx-auto">
          {TEAM.map((m) => (
            <div
              key={m.name}
              className="group rounded-2xl bg-white border border-slate-200 p-6 text-center hover:border-blue-300 hover:shadow-xl hover:shadow-blue-100/50 hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <div className="flex justify-center gap-2 mt-4 opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-0 transition duration-300">
                <a
                  ...
                  className="w-8 h-8 rounded-lg bg-slate-100 grid place-items-center text-blue-600 hover:bg-blue-100 transition"
                >
                  <LinkedInIcon />
                </a>
                <a
