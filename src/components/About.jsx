        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative">
            ...
            <div className="hidden md:flex absolute -bottom-6 -right-6 px-5 py-4 rounded-2xl bg-white border border-slate-200 shadow-xl items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-violet-600 grid place-items-center text-white">
          ...
          <div>
            ...
            <div className="mt-8 grid sm:grid-cols-2 gap-4">
              {POINTS.map((p) => (
                <div
                  key={p.title}
                  className="group p-4 rounded-2xl bg-white border border-slate-200 hover:border-violet-300 hover:shadow-lg hover:shadow-violet-100 hover:-translate-y-0.5 transition-all duration-300"
                >
                  <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-cyan-100 to-violet-100 grid place-items-center mb-3 group-hover:scale-110 transition">
