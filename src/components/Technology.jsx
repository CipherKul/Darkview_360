      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {!hideHeader && (
          <div className="text-center max-w-2xl mx-auto mb-14">
            <div className="inline-block px-3 py-1 rounded-full bg-fuchsia-100 border border-fuchsia-200 text-fuchsia-700 text-xs font-semibold tracking-wider uppercase mb-4">
              Our Technology
            </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {TECH_FEATURES.map((f) => (
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-slate-100 grid place-items-center mb-4 group-hover:bg-gradient-to-br group-hover:from-cyan-100 group-hover:to-violet-100 transition">
